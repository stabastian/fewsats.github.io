...
var CalculatorRow = function CalculatorRow(_ref) {
  ...
  return __jsx("tr", {
    ...
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_2__["default"])('text-sm w-full text-right bg-background', variant === 'long' && 'text-green font-bold', variant === 'short' && 'text-red font-bold', type === 'text' && 'text-red font-bold', !variant && (readOnly ? 'text-lgray ' : 'text-text')),
    type: type,
    name: name,
    onChange: onChange,
    value: value,
...
//# sourceMappingURL=compound-interest-calculator.js.0ec4329c5a8d19cf25c7.hot-update.js.map