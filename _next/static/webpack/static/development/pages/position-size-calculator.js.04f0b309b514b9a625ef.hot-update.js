...
var CalculatorRow = function CalculatorRow(_ref) {
  ...
  return __jsx("tr", {
    ...
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_2__["default"])('text-xs w-full text-right bg-background', variant === 'long' && 'text-green font-bold', variant === 'short' && 'text-red font-bold', !variant && (readOnly ? 'text-lgray ' : 'text-text')),
    type: "number",
    name: name,
    onChange: onChange,
    value: value,
...
//# sourceMappingURL=position-size-calculator.js.04f0b309b514b9a625ef.hot-update.js.map