...
var CalculatorRow = function CalculatorRow(_ref) {
  ...
  return __jsx("tr", {
    ...
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_2__["default"])(readOnly ? 'bg-background' : 'bg-link font-semibold', variant === 'long' && 'text-green font-bold', variant === 'short' && 'text-red font-bold', !variant && 'text-text font-semi-bold', 'truncate p-1 w-2/3 border border-highlight'),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
...
//# sourceMappingURL=position-size-calculator.js.fb2729b23bf8984083db.hot-update.js.map