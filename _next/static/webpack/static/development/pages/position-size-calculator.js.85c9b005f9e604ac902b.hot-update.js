...
var CalculatorRow = function CalculatorRow(_ref) {
  ...
  return __jsx("tr", {
    ...
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_2__["default"])(readOnly ? 'bg-background' : 'bg-muted font-semibold', variant === 'long' && 'text-green font-bold', variant === 'short' && 'text-red font-bold', !variant && 'text-text font-semi-bold', 'truncate p-1 w-2/3 border border-accent'),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
    ...
    className: "p-1 w-1/3 border border-lgray",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45
    },
...
//# sourceMappingURL=position-size-calculator.js.85c9b005f9e604ac902b.hot-update.js.map