...
var CalculatorRow = function CalculatorRow(_ref) {
  ...
  return __jsx("tr", {
    ...
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_2__["default"])(readOnly ? 'bg-background' : 'bg-muted font-semibold', variant === 'long' && 'text-green font-bold', variant === 'short' && 'text-red font-bold', !variant && 'text-text font-semi-bold', 'truncate p-1 w-2/3 border border-highlight text-md'),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
...
//# sourceMappingURL=position-size-calculator.js.c731a9472b0e14db545a.hot-update.js.map