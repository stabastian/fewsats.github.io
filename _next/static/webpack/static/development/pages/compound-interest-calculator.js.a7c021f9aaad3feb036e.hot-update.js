...
var CalculatorRow = function CalculatorRow(_ref) {
  ...
  return __jsx("tr", {
    ...
    className: Object(clsx__WEBPACK_IMPORTED_MODULE_2__["default"])('text-sm w-full text-right bg-background', variant === 'long' && 'text-green font-bold', variant === 'short' && 'text-red font-bold', type === 'text' && 'pl-1', !variant && (readOnly ? 'text-lgray ' : 'text-text')),
    type: type,
    name: name,
    onChange: onChange,
    value: value,
...
//# sourceMappingURL=compound-interest-calculator.js.a7c021f9aaad3feb036e.hot-update.js.map